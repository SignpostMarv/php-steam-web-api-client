...
class ISteamUser extends AbstractInterface
{
     ...
     */
    public function GetFriendListV1(string $steamid, string $relationship = null)
    {
     ...
     */
    public function GetPlayerBansV1(string $steamids)
    {
     ...
     * @param string $steamids Comma-delimited list of SteamIDs
     */
    public function GetPlayerSummariesV1(string $steamids)
    {
        return $this->_call(__METHOD__, 'GET', array('steamids' => $steamids));
    }
    /**
     ...
     */
    public function GetPlayerSummariesV2(string $steamids)
    {
        return $this->_call(__METHOD__, 'GET', array('steamids' => $steamids));
    }
    /**
     ...
     * @param uint64 $steamid SteamID of user
     */
    public function GetUserGroupListV1(string $steamid)
    {
     ...
     */
    public function ResolveVanityURLV1(string $vanityurl, integer $url_type = null)
    {
