...
class ISteamUserAuth extends AbstractInterface
{
     ...
     */
    public function AuthenticateUserV1(string $steamid, string $sessionkey, string $encrypted_loginkey)
    {
     ...
     */
    public function AuthenticateUserTicketV1(string $appid, string $ticket)
    {
