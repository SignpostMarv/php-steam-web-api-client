...
class IPublishedFileService extends AbstractInterface
{
     ...
     */
    public function QueryFilesV1(string $query_type, string $page, string $numperpage = null, string $creator_appid, string $appid, string $requiredtags, string $excludedtags, bool $match_all_tags = null, string $required_flags, string $omitted_flags, string $search_text, string $filetype, string $child_publishedfileid, string $days, bool $include_recent_votes_only, string $cache_max_age_seconds = null, integer $language = null, array $required_kv_tags, bool $totalonly, bool $ids_only, bool $return_vote_data, bool $return_tags, bool $return_kv_tags, bool $return_previews, bool $return_children, bool $return_short_description, bool $return_for_sale_data, bool $return_metadata = null, string $return_playtime_stats)
    {
