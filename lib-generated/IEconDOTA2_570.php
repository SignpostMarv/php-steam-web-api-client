...
class IEconDOTA2_570 extends AbstractInterface
{
     ...
     */
    public function GetEventStatsForAccountV1(string $eventid, string $accountid, string $language = null)
    {
     ...
     */
    public function GetGameItemsV1(string $language = null)
    {
     ...
     */
    public function GetHeroesV1(string $language = null, bool $itemizedonly = null)
    {
     ...
     */
    public function GetItemIconPathV1(string $iconname, string $icontype = null)
    {
     ...
     */
    public function GetRaritiesV1(string $language = null)
    {
        return $this->_call(__METHOD__, 'GET', array('language' => $language));
    }
    /**
     ...
     */
    public function GetTournamentPrizePoolV1(string $leagueid = null)
    {
