...
class ISteamCDN extends AbstractInterface
{
     ...
     */
    public function SetClientFiltersV1(string $cdnname, string $allowedipblocks = null, string $allowedasns = null, string $allowedipcountries = null)
    {
     ...
     */
    public function SetPerformanceStatsV1(string $cdnname, string $mbps_sent = null, string $mbps_recv = null, string $cpu_percent = null, string $cache_hit_percent = null)
    {
